    ...
    def _build_persistence_failure_result(
        ...
        return ApplicationResult(
            ...
            error=ApplicationError(
                ...
                message="Failed to persist enrollment cancellation.",
                details={
                    "aggregate_id": enrollment_id,
                    "action": "cancel",
    ...
    def execute(
        ...
        if not state_changed:
            if events_snapshot:
                return self._build_state_integrity_result(
                    ...
                    message="Cancellation produced pending domain events without a state change.",
                )
            return ApplicationResult(
                aggregate_id=enrollment_id,
                changed=False,
        ...
        if not events_snapshot:
            return self._build_state_integrity_result(
                ...
                message="Cancellation changed state without emitting a domain event.",
            )
